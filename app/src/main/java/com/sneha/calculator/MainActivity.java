...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonMultiply, buttonSubs, buttonDivision, buttonPoint, buttonPercent, buttonPower, buttonEqual, buttonClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubs = findViewById(R.id.subtact_btn);
    ...
    private void solve() {
        ...
        if (input.split("\\^").length == 2) {
            numbers = input.split("\\^");
            try {
                double d = Math.pow(Double.parseDouble(numbers[1]), Double.parseDouble(numbers[0]));
                output = Double.toString(d);
                newOutput = cutDecimal(output);
                outputText.setText(newOutput);
                input = d + "";
